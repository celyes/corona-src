...
(() => {
  ...
  let cases = [
        ["البليدة",59,36.4889434,2.7685398], // blida
        ["الجزائر العاصمة",7,36.7631,3.0506,], // alger
        ["تيزي وزو",5,36.7169,4.0497], // tizi ouzou
        ...
        ["برج بوعريريج",1,36.0676,4.7453], // bordj bouarreridj
